...
{{
var G__4753 = cljs.core.pop.call(null,v__$1);
v__$1 = G__4753;
continue;
}
} else
...
{var pred__4757 = cljs.core._EQ_;var expr__4758 = limit;if(cljs.core.truth_(pred__4757.call(null,1,expr__4758)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__4757.call(null,2,expr__4758)))
...
var G__4760 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__4761 = (limit__$1 - 1);
var G__4762 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__4760;
limit__$1 = G__4761;
parts = G__4762;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___4764 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___4764))
{var replacement_4765 = temp__4090__auto___4764;buffer.append([cljs.core.str(replacement_4765)].join(''));
} else
{buffer.append(ch);
}
{
